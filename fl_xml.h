...
log.set_rst_in                  s:n     Sets the RST(r) field contents.
log.set_rst_out                 s:n     Sets the RST(s) field contents.
...
navtex.send_message             s:s     Send a Navtex/SitorB message. Returns an
*/
